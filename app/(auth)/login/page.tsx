    ...
    <div className="w-full max-w-md">
      ...
      <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8">
        ...
        <p className="text-center text-sm text-slate-500 mt-5">
          ...
          <Link href="/register" className="text-primary-400 font-semibold hover:text-primary-300">Register</Link>
        </p>
      </div>
      <p className="text-center text-xs text-slate-600 mt-4">🔒 Secured by Firebase Authentication</p>
    </div>
  );
}