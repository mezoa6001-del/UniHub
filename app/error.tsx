...
export default function Errorhage({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  ...
  return (
    <div className="min-h-screen bg-[#0A1628] flex items-center justify-center p-4">
      <div className="text-center max-w-md">
        ...
        <p className="text-slate-400 mb-6 text-sm">{error.message || "An unexpected error occurred in nniHub."}</p>
